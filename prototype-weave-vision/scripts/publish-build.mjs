...
const htmlDest = path.join(root, "prototype-capability-control-center.html");
const assetsSrc = path.join(dist, "assets");
const assetsDest = path.join(root, "assets", "weave-vision-app");
...
html = html.replace(/\.\/assets\//g, "./assets/weave-vision-app/");
